...
bool NR_Solution::_is_solved = false;
...
// SETTERS
void NR_Solution::set_solved(bool bool_set) { NR_Solution::_is_solved = bool_set; }
...
void NR_Solution::algorithm_step(NR_Solution* final_nr_solution_ptr) {

	// IS SOLVED EDGE CASE
	if (_repository.is_empty()) { 
		_is_solved = true;
		*final_nr_solution_ptr = *this;
		return;
	}
